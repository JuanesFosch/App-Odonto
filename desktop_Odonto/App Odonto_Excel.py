...
"""CREAR OTRO LAYOUT Y BUCLE DE CARGA PARA EL PRESUPUESTO, QUE ESCRIBA SOBRE EL MISMO ARCHIVO"""
...
while True:
    ...
    if event == 'Cargar':
        ...
        df = pd.concat([df_pacientes, new_record], ignore_index=True) # Escribe datos nuevos.
